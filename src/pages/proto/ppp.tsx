        ...
        <div className="space-y-6 animate-fade-in">
          <div className="mb-6">
            ...
            <p className="text-gray-500">
              Daftar saran menu dan masukan dari siswa penerima manfaat.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-6">
            {suggestions.length > 0 ? (
              suggestions.map((schoolGroup) => (
                <div
                  key={schoolGroup.schoolId}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {schoolGroup.items.length} Masukan
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="divide-y divide-gray-100">
                    {schoolGroup.items.map((item: any) => (
                      <div
                        key={item.id}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 text-xs text-blue-600 bg-blue-50 px-3 py-1.5 rounded-lg w-fit">
                          <span className="font-semibold">Pilihan Menu:</span>
                          <span>{item.menuChoice}</span>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="text-center py-12 bg-white rounded-xl border border-gray-100">
                ...
                <p className="text-gray-500">
                  Belum ada saran atau masukan dari siswa saat ini.
                </p>
              </div>
            )}
          </div>
